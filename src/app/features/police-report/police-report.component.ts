...
export class PoliceReportComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  initiateForms() {
    ...
    this.policeReportForm_2 = this.fb.group({
      ...
      veh1OperatorLastName: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh1OperatorFirstName: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh1OperatorMiddleName: [''],
      veh1OperatorCity: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh1OperatorState: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh1OperatorZip: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh1InsuranceCompany: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      ...
      veh1RegState: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      ...
      veh1VehicleConfig: [''],
      veh1OwnerLastName: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh1OwnerFirstName: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh1OwnerMiddleName: [''],
      veh1OwnerAddress: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh1OwnerCity: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh1OwnerState: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9]")]],
    ...
    this.policeReportForm_3 = this.fb.group({
      ...
      veh2OperatorLastName: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh2OperatorFirstName: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh2OperatorMiddleName: [''],
      veh2OperatorCity: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh2OperatorState2: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh2OperatorZip: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh2InsuranceCompany: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      ...
      veh2RegState: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      ...
      veh2VehicleConfig: [''],
      veh2OwnerLastName: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh2OwnerFirstName: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh2OwnerMiddleName: [''],
      veh2OwnerAddress: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh2OwnerCity: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
      veh2OwnerState: ['', [Validators.required,Validators.pattern(".*\\S.*[a-zA-z0-9 ]")]],
  ...
  onIntersectionChange(event: any) {
    if (event.value) {
      ...
      this.policeReportForm_1.controls['naiRoadwaySt1'].setValidators([Validators.required]);
      this.policeReportForm_1.controls['feet3'].setValidators([Validators.required]);
      this.policeReportForm_1.controls['naiDirection3'].setValidators([Validators.required]);
      this.policeReportForm_1.controls['naiLandmark'].setValidators([Validators.required]);
      this.policeReportForm_1.updateValueAndValidity();
    }
  }
